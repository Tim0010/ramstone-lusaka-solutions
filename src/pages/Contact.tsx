...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const phoneNumber = "260974622334"; // Phone number from contactInfo
    ...
    toast({
      ...
      description: "Please send the pre-filled message from WhatsApp.",
    });
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      details: "grayheavens891@gmail.com",
      action: "Send Email"
    },
    {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-20 bg-cover bg-center"
        style={{ backgroundImage: "url('/images/contact_us.jpeg')" }}
      >
                  ...
                  <Button size="sm" variant="outline" className="text-primary border-primary hover:bg-primary hover:text-white"
                    onClick={() => {
                      if (info.title === "Location") {
                        window.open("https://www.google.com/maps/dir/?api=1&destination=23A+Great+East+Road,+Avondale,+Lusaka,+Zambia", "_blank");
                ...
                <CardContent className="p-8">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="md:col-span-2">
                      <Button type="submit" size="lg" className="w-full bg-primary hover:bg-red-600">
                        Send Message
                      </Button>
                    </div>
                  </form>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Button 
                        ...
                        onClick={() => {
                          const phone = "260974622334"; // Corrected phone number
                      ...
                      <Button 
                        ...
                        onClick={() => window.location.href = "tel:+260974622334"} // Corrected phone number and styling
                      >
            ...
            <div>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="mt-4 p-3 bg-red-50 rounded-lg border-l-4 border-primary">
